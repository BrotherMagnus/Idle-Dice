...
# Where your dice PNGs live (e.g., images/wooden_d8.png)
...
def _base_stats(set_key: str, rarity: str, sides: int):
    ...
    flavor = {
        "stone":       {"hp": 1.05, "atk": 0.95, "def": 1.10, "spd": 0.95},
        "plastic":     {"hp": 0.95, "atk": 1.05, "def": 0.95, "spd": 1.12},
        "clay":        {"hp": 1.05, "atk": 0.97, "def": 1.05, "spd": 0.98},
        "aluminum":    {"hp": 0.98, "atk": 1.03, "def": 0.98, "spd": 1.08},
