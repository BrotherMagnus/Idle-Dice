...
class GamesScreen(QWidget):
    def __init__(self, main_window):
        ...
        # Scrap (always available)
        self.scrap_card = self._make_card(
            "Scrap", "Salvage gold into scrap with a chance for bonuses.",
            [("Play", self._open_scrap), ("Upgrades", lambda: self._open_upgrades("scrap"))]
        )
        self.card_grid.addWidget(self.scrap_card, 1, 1)
    ...
    def _open_scrap(self): self.mw.show_game(direct_tab="Scrap")
